...
<div class="container-fluid pt-4 px-4">
    <div class="row vh-20 bg-light rounded align-items-center justify-content-center mx-0">
        <div class="d-flex align-items-center justify-content-between my-4">
            <h3 class="mb-0">Templates </h6>
            {{-- <a href="" class="btn btn-primary" data-bs-toggle="modal"
            data-bs-target="#templateModal">Add New</a> --}}
        </div>
    </div>
</div>
<!-- End -->
                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img class="" src="{{asset('upload/template/'.$template->image)}}"
                                alt="" style="width: 100px; border-radius: 12px;"></td>
                            <td>
                                <video controls height="150px" style="width: 250px;">
                            ...
                            <td>
                                ...
                                <a href="{{ route('active.template', ['id' => $template->id] )}}" class="btn btn-success btn-sm"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Mark Active">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </a>
                                @else
                                <b class="text-success">Active</b>
                                <a href="{{ route('deactive.template', ['id' => $template->id] )}}" class="btn btn-warning btn-sm"
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('edit.template', ['id' => $template->id] )}}" class="btn btn-warning"><i
                                            class="fa fa-pen"></i> </a></a>
                                    {{-- <a href="{{ route('delete.template', ['id' => $template->id] )}}" class="btn btn-danger"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg-light">
            <div class="modal-header">
                <h5 class="modal-title" id="templateModalLabel">Add Item</h5>
                <button type="button" class="btn-close btn-light" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('save.template')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                <label for="demo_video"> <b>Image</b></label>
                                <input type="file" name="demo_video" class="form-control"  accept="">
                            </div>
                        </div>
                        <br>
                        <div class="col-lg-12">
