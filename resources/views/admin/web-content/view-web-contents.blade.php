                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($web_content->status == 0)
                                <b class="text-danger">Inactive</b>
                                <a href="{{ route('active.web.content', ['id' => $web_content->id] )}}" class="btn btn-success btn-sm"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Mark Active">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </a>
                                @else
                                <b class="text-success">Active</b>
                                <a href="{{ route('deactive.web.content', ['id' => $web_content->id] )}}" class="btn btn-warning btn-sm"
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('edit.web.content', ['id' => $web_content->id] )}}" class="btn btn-warning"><i
                                            class="fa fa-pen"></i> </a>
                                    {{-- <a href="{{ route('delete.web.content', ['id' => $web_content->id] )}}" class="btn btn-danger"
