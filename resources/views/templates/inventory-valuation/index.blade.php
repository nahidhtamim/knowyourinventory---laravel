...
@section('title')
Inventory Valution | Know Your Inventory
@endsection
...
<div class="container">
    <div class="row">
        <form action="{{route('save.inventory.valuation')}}" method="POST" id="dataEntryForm">
            @csrf
            ...
            <div class="col-lg-12">
                <div class="table-responsive">
                    ...
                    <table id="inventory_table" class="table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <td class="text-center"><p>Number of Rows: <span class="row_count_output">39</span></p></td>
                                <td class="text-center">TOTAL</td>
                                <td><input type="text" class="form-control total_inventory" name="total_inventory" required readonly></td>
                            </tr>
                        </tfoot>
